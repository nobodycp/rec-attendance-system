...
<div class="page-header">
    ...
    <p class="page-header__subtitle">عرض درجة الحضور والأداء لكل موظف.</p>
</div>
...
<div class="card"><p class="table-empty" style="padding:2rem">لا يوجد موظفون لعرض تقاريرهم.</p></div>
<?php endif; ?>
